            ...
            'this-year': [
                {
                    name: 'Earnings',
                    data: [
                        { x: 'Chinedu Ifeanyi', y: 4884 },
                        { x: 'Leonardo Watkins', y: 7500 },
                        { x: 'Jessica Tanner', y: 10500 },
                        { x: 'Derek Lowe', y: 5600 },
                        { x: 'Samantha Reed', y: 23000 },
                    ]
                },
            ],
            'last-year': [
                {
                    name: 'Earnings',
                    data: [
                        { x: 'Chinedu Ifeanyi', y: 8084 },
                        { x: 'Leonardo Watkins', y: 7400 },
                        { x: 'Jessica Tanner', y: 12500 },
                        { x: 'Derek Lowe', y: 9600 },
                        { x: 'Samantha Reed', y: 3000 },
                    ]
                },
            ],
        },
